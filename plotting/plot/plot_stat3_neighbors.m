function [] = plot_stat3_neighbors(dependency_directory)
...
to_plot{2}=neighbor_table.neighbors(temp_index);

to_plot{1}=neighbor_table.neighbors(v_mutated_residue);

to_plot{3}=neighbor_table.neighbors(v_gnomad_residue);
