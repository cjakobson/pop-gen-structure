function [] = plot_neighbor_sim_1K_2D_superfam(plot_offset,dependency_directory)
...
xtickangle(45)
title('C_\alpha within 10 Ang. in domain')
...
xticklabels(structure_labels)
xtickangle(45)
title('C_\alpha within 10 Ang. outside domain')
xlim([0.5 length(structure_labels)+.5])
ylim([0.5 length(aa_labels)+.5])
colormap(c)
colorbar
