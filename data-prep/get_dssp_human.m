function output_table=get_dssp_human(dependency_directory,systematic_name,pdb_id,dna_sequence)

fileToGet=[dependency_directory 'human-data/dssp-output/AF-' pdb_id '-F1-model_v4.pdbdssp.txt'];
