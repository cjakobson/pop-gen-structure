function output_table=get_neighbors_human(dependency_directory,systematic_name,pdb_id)

file_to_get=[dependency_directory 'human-data/neighbor-output/' pdb_id '_10A.txt'];
